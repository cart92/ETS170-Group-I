...
%==================================
% Macros.
\newcommand{\balls}{\textquotesingle}
...
\subsection{Terminology}
	...
	\item[The application] is referring to the ordered application for a shopping mall, i.e. the ordered product.
...
\textit{
"Jonathan is walking around in the mall with the mall\balls s new application ShopMate installed on his Android phone. He walks past a few stores in the mall 
...
\underline{Offer --- Location offers} \\ The offers shall be relevant to the user\balls s location in the mall.\\ \par
...
\underline{Offer --- Limit of displaying offers} \\ The product may show a new offer every 120 seconds. \\ \par
 ...
 whole screen they could look like displayed in figure \ref{fig:offer}.  
  ...
  \begin{figure}[H]
    ...
    \caption{Refers to the requirement \textit{Offer --- Non-annoying commercials.}}
    \label{fig:offer}
\end{figure}
...
the product shouldn\balls t have to experience these concerns. \\ \par
...
departures from the user\balls s current location to the mall, using public transportation.
...
\underline{Smart-watch --- Shopping list} \\ The product shall be able to display the user\balls s shopping-list on the Smart-Watch. \\ \par 
...
The tables below show which features that are present, depending on what state the user\balls s device have. 
